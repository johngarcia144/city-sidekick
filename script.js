...
function Search() {
    if (!searchManager) {
        ...
        var query = document.getElementById('input-city').value;
        ...
        //example search input to test, will need to attach the dropdown menu to this
        ...
        callback: function (r) {
            ...
            if (r && r.results && r.results.length > 0) {
                ...
                for (var i = 0; i < 1; i++) {//replaced r.results.length with "1" to stop multiple locations/pins from showing up
                    ...
                    console.log("Does this work?",r.results[i].location.latitude);
                    console.log("Does this work?",r.results[i].location.longitude);
